# AGENTS.md — @solvedbydev/pi-extensions
...
In this repo, quality matters! If you added logic but not tests, your work is not complete. Untested code is legacy code is a job unfinished. Prefer a red/green/refactor model for adding new code.

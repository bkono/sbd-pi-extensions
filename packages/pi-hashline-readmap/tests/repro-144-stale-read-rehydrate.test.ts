    ...
    await handlers.tool_result(
      {
        ...
        toolCallId: "read-1",
        input: { path: filePath },
        content: readResult1.content,
        isError: false,
        details: readResult1.details,
      },
      {},
    );
    ...
    await handlers.tool_result(
      {
        ...
        toolCallId: "read-2",
        input: { path: filePath },
        content: readResult2.content,
        isError: false,
        details: readResult2.details,
      },
      {},
    );

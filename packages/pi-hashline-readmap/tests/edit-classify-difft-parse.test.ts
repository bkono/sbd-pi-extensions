        ...
        [
          {
            lhs: {
              line_number: 1,
              changes: [{ start: 8, end: 9, content: "x", highlight: "normal" }],
            },
            rhs: {
              line_number: 1,
              changes: [{ start: 8, end: 9, content: "y", highlight: "normal" }],
            },
          },
        ],
      ],
        ...
        [
          {
            rhs: {
              line_number: 0,
              changes: [{ start: 0, end: 8, content: "function", highlight: "keyword" }],
            },
          },
        ],
        [
        ...
        [
          {
            rhs: {
              line_number: 0,
              changes: [{ start: 0, end: 3, content: "AAA", highlight: "normal" }],
            },
          },
        ],
        [
          {
            lhs: {
              line_number: 4,
              changes: [{ start: 0, end: 3, content: "BBB", highlight: "normal" }],
            },
          },
        ],
      ],

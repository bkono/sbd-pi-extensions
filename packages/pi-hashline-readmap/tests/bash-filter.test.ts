...
describe("filterBashOutput routing", () => {
  ...
  it("does not compact compound git command output as a single status result", () => {
    const command = "git status --short; git branch --show-current; git log --oneline -8";
  ...
  it("routes linter commands to aggregateLinterOutput and falls back when null", () => {
    const spy = vi
      ...
      .mockReturnValue("compressed linter output");
  ...
  it("falls through to build filtering when linter route matches but returns null", () => {
    ...
    const buildSpy = vi
      ...
      .mockReturnValue("build fallback output");
  ...
  it("routes build commands to filterBuildOutput and falls back when null", () => {
    const spy = vi
      .spyOn(buildModule, "filterBuildOutput")
      .mockReturnValue("compressed build output");
  ...
  it("routes make commands to compressBuildToolsOutput", () => {
    const spy = vi
      .spyOn(buildToolsModule, "compressBuildToolsOutput")
      .mockReturnValue("compressed make output");
  ...
  it("routes cmake commands to compressBuildToolsOutput", () => {
    const spy = vi
      .spyOn(buildToolsModule, "compressBuildToolsOutput")
      .mockReturnValue("compressed cmake output");
  ...
  it("routes rsync commands to compressTransferOutput", () => {
    const spy = vi
      .spyOn(transferModule, "compressTransferOutput")
      .mockReturnValue("compressed rsync output");
  ...
  it("routes scp commands to compressTransferOutput", () => {
    const spy = vi
      .spyOn(transferModule, "compressTransferOutput")
      .mockReturnValue("compressed scp output");

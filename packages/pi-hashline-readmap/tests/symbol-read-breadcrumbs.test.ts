    ...
    const map = makeMap([
      {
        ...
        startLine: 1,
        endLine: 50,
        children: [{ name: "myMethod", kind: SymbolKind.Method, startLine: 10, endLine: 20 }],
      },
    ]);
    ...
    const map = makeMap([
      {
        ...
        startLine: 1,
        endLine: 80,
        children: [{ name: "uniqueChild", kind: SymbolKind.Method, startLine: 30, endLine: 40 }],
      },
        ...
        children: [
          {
            ...
            startLine: 5,
            endLine: 90,
            children: [{ name: "deepMethod", kind: SymbolKind.Method, startLine: 10, endLine: 20 }],
          },
        ],
      },
    ]);

...
function staleRecordsByResultId(
...
function retiredRecordsByResultId(
  report: ContextHygieneReport,
...
function maskStaleToolResultMessage<T extends ContextToolResultMessage>(
  message: T,
...
function maskRetiredToolResultMessage<T extends ContextToolResultMessage>(
  message: T,

export type HashlineToolName = "read" | "grep" | "ast_search" | "edit" | "write" | "ls" | "find";

export type HashlineToolMutability = "read-only" | "mutating";

export type HashlineToolDefaultExposure = "safe-by-default" | "opt-in" | "not-safe-by-default";

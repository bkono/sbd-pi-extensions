...
const COMPACT_DESCRIPTIONS: Record<string, string> = {
  "read.md":
    "Read text files/images by path; text has LINE:HASH anchors, images return attachments.",
  "edit.md":
    "Edit existing text files using fresh LINE:HASH anchors from read, grep, ast_search, or write.",
...
const COMPACT_GUIDELINES: Record<string, string[]> = {
  ...
  "find.md": ["Use find for recursive file discovery by glob."],
  "ls.md": ["Use ls to list one directory, optionally with a glob filter."],
  "write.md": [
  ...
  "sg.md": ["Use ast_search for AST-shaped code patterns."],
};

 ...
 */
function convertSectionsToSymbols(sections: TomlSection[], totalLines: number): FileSymbol[] {
 ...
 */
export async function tomlMapper(filePath: string, signal?: AbortSignal): Promise<FileMap | null> {
  try {

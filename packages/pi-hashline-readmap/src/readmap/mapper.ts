...
import { MAPPER_VERSION as C_VERSION, cMapper } from "./mappers/c.js";
import { MAPPER_VERSION as CPP_VERSION, cppMapper } from "./mappers/cpp.js";
import { MAPPER_VERSION as CSV_VERSION, csvMapper } from "./mappers/csv.js";
import { MAPPER_VERSION as CTAGS_VERSION, ctagsMapper } from "./mappers/ctags.js";
import { MAPPER_VERSION as FALLBACK_VERSION, fallbackMapper } from "./mappers/fallback.js";
import { MAPPER_VERSION as GDSCRIPT_VERSION, gdscriptMapper } from "./mappers/gdscript.js";
import { MAPPER_VERSION as GO_VERSION, goMapper } from "./mappers/go.js";
import {
  MAPPER_VERSION as JAVA_VERSION,
  javaMapper,
  javaMapperFromContent,
} from "./mappers/java.js";
import { MAPPER_VERSION as JSON_VERSION, jsonMapper } from "./mappers/json.js";
import { MAPPER_VERSION as JSONL_VERSION, jsonlMapper } from "./mappers/jsonl.js";
import { MAPPER_VERSION as MARKDOWN_VERSION, markdownMapper } from "./mappers/markdown.js";
import { MAPPER_VERSION as PYTHON_VERSION, pythonMapper } from "./mappers/python.js";
import {
  MAPPER_VERSION as RUST_VERSION,
  rustMapper,
  rustMapperFromContent,
} from "./mappers/rust.js";
import { MAPPER_VERSION as SHELL_VERSION, shellMapper } from "./mappers/shell.js";
import { MAPPER_VERSION as SQL_VERSION, sqlMapper } from "./mappers/sql.js";
import { MAPPER_VERSION as SWIFT_VERSION, swiftMapper } from "./mappers/swift.js";
import { MAPPER_VERSION as TOML_VERSION, tomlMapper } from "./mappers/toml.js";
import {
  MAPPER_VERSION as TYPESCRIPT_VERSION,
  typescriptMapper,
  typescriptMapperFromContent,
} from "./mappers/typescript.js";
import { MAPPER_VERSION as YAML_VERSION, yamlMapper } from "./mappers/yaml.js";
import type { FileMap, MapOptions } from "./types.js";

type MapperFn = (filePath: string, signal?: AbortSignal) => Promise<FileMap | null>;
 ...
 */
export function shouldGenerateMap(totalLines: number, totalBytes: number): boolean {
